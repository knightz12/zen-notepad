...
function createWindow(initialFile = null, emptyWindow = false) {
  ...
  win.webContents.once("did-finish-load", () => {
    if (initialFile) {
      ...
      win.webContents.send("open-empty-window");
    }
  });
}
...
app.on("second-instance", (_, commandLine) => {
  ...
  // If user opened a file, open it in current window
  ...
  // If user opened the app again with no file, create empty new window
